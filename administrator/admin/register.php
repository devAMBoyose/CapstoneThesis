...
<html lang="en">
  ...
  <header class="main-header clearfix float-center" role="header">
      <div class="logo">
        <a href="#"><em>User</em> Registration</a>
      </div>
...
<BR><BR></BR></BR>
            ...
            <div class="col-md-8 offset-md-2">
             	<form method="POST" enctype="multipart/form-data">
				  ...
				  <div class="form-group row">
					  ...
					  <p>The user must be more than 8 charset </p>
				    </div>
				    <div class="col-sm-4">
					  ...
					  <p>Password must be more than 8 charset</p>
				    </div>
				    <div class="col-sm-4">
    ...
    <footer>
    	<p>Copyright &copy; Group1 <?php echo date('Y') ?></p>
    </footer>
    <!-- Optional JavaScript -->
