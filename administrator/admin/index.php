...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="index.php"><i class="fas fa-laugh-wink" style="color: #ffffff;"></i></a>
...
<br>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="index.php?page=add-student" class="list-group-item list-group-item-action"><i class="fa-solid fa-person-circle-plus"></i>Add Student</a>
              <a href="index.php?page=all-student" class="list-group-item list-group-item-action"><i class="fa-solid fa-users-between-lines"></i> All Students</a>
              <a href="index.php?page=all-users" class="list-group-item list-group-item-action"><i class="fa-solid fa-users-viewfinder"></i> All Users</a>
              <a href="index.php?page=user-profile" class="list-group-item list-group-item-action"><i class="fa-solid fa-user-secret"></i> User Profile</a>
            </div>
          </div>
    ...
    <script src="https://kit.fontawesome.com/e6a8da8c21.js" crossorigin="anonymous"></script>
  </body>
</html>